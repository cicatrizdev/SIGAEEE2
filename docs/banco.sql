...
-- Thu 27 Sep 2018 02:09:14 PM -03
...
-- Schema sigaeee
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sigaeee`
...
CREATE TABLE IF NOT EXISTS `sigaeee`.`usuario` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_usuario_atleta1_idx` (`atleta_id` ASC),
  INDEX `fk_usuario_gestor1_idx` (`gestor_id` ASC),
  CONSTRAINT `fk_usuario_atleta1`
  FOREIGN KEY (`atleta_id`)
  REFERENCES `sigaeee`.`atleta` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_gestor1`
  FOREIGN KEY (`gestor_id`)
  REFERENCES `sigaeee`.`gestor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB;
